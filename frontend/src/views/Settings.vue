...
import { scheduleApi, configTestApi } from '../api'
import {
  type ScheduleConfig,
...
<template>
  <div class="settings">
    ...
    <!-- 配置可用性测试 -->
    <div class="settings-card" v-loading="emailConfigLoading">
      <div class="card-header">
        <div class="card-title-wrap">
          <div class="card-icon">
          ...
          <div>
            <h3 class="card-title">配置可用性测试</h3>
            <p class="card-desc">检查外部服务配置是否可用，当前支持邮件发送测试</p>
          </div>
        </div>
      </div>

      <div class="card-body">
        <div class="config-test-list">
          <div class="config-test-row">
            <div class="test-service-main">
              <div class="test-title-line">
                <span
                  class="status-dot"
                  :class="{ ok: emailConfig?.configured, fail: emailConfig && !emailConfig.configured }"
                ></span>
                <span class="service-name">邮件发送</span>
                <span
                  class="service-state"
                  :class="{ ok: emailConfig?.configured, fail: emailConfig && !emailConfig.configured }"
                >
          ...
          <div class="config-test-row muted">
            <div class="test-service-main">
              <div class="test-title-line">
              ...
              <div class="test-meta">
                <span>后续接入 LLM Provider、Base URL、API Key 和模型连通性测试</span>
              </div>
            </div>
          </div>
          ...
          <div class="config-test-row muted">
            <div class="test-service-main">
              ...
              <div class="test-meta">
                <span>后续接入 SerpAPI 等搜索服务的密钥校验</span>
              </div>
            </div>
          </div>
        </div>
